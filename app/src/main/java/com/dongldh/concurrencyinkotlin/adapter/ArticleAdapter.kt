package com.dongldh.concurrencyinkotlin.adapter
...
import com.dongldh.concurrencyinkotlin.R
...
class ArticleAdapter: RecyclerView.Adapter<ArticleAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val layout = LayoutInflater.from(parent.context).inflate(R.layout.item_article, parent, false) as LinearLayout
